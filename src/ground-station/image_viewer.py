...
class ImageViewer:
    ...
    def setup_gui(self) -> None:
        ...
        self.progress: ttk.Progressbar = ttk.Progressbar(control_frame, variable=self.progress_var,
        ...
        v_scrollbar: ttk.Scrollbar = ttk.Scrollbar(self.image_frame, orient=tk.VERTICAL,
                                   command=self.canvas.yview)
        h_scrollbar: ttk.Scrollbar = ttk.Scrollbar(self.image_frame, orient=tk.HORIZONTAL,
    ...
    def assemble_image(self) -> None:
        ...
        try:
            ...
            sorted_chunks: List[bytes] = [self.image_chunks[i] for i in sorted(self.image_chunks.keys())]
            ...
            # Update status
            elapsed: float = time.time() - self.image_start_time if self.image_start_time else 0
    ...
    def display_image(self, image: Image.Image) -> None:
        ...
        if canvas_width > 10 and canvas_height > 10:
            ...
            display_img: Image.Image = image.resize((new_width, new_height), Image.Resampling.LANCZOS)
        else:
            display_img = image

        # Convert to PhotoImage
        self.photo: ImageTk.PhotoImage = ImageTk.PhotoImage(display_img)  # type: ignore
    ...
    def on_mousewheel(self, event: tk.Event) -> None:  # type: ignore
        ...
        if self.current_image and self.image_on_canvas:
            ...
            # Resize and display
            resized: Image.Image = self.current_image.resize((new_width, new_height),
