...
class SimpleLogger:
    ...
    def __init__(self, name: str = "CubeSat", log_dir: str = "./logs") -> None:
        ...
        file_handler: logging.handlers.RotatingFileHandler = logging.handlers.RotatingFileHandler(  # type: ignore
        ...
        if os.environ.get('CUBESAT_DEBUG', '').lower() == 'true':
            console_handler: logging.StreamHandler = logging.StreamHandler(sys.stdout)  # type: ignore
...
class SimpleHealthMonitor:
    ...
    def _check_simple_thresholds(self) -> None:
        ...
        try:
            ...
            try:
                statvfs: os.statvfs_result = os.statvfs('/')  # type: ignore
